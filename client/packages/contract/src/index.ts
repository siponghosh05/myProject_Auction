...
export const networks = {
  testnet: {
    ...
    contractId: "CCCOKUMZI56EVHL2SHH776YEB72ZK5PDDA73HSCQZM6KKFMLKZGBKS7Q",
  }
} as const
...
export interface Client {
   ...
   */
  end_auction: ({seller}: {seller: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  get_auction: (options?: MethodOptions) => Promise<AssembledTransaction<Auction>>
   ...
   */
  create_auction: ({seller, item}: {seller: string, item: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAAB0F1Y3Rpb24AAAAABQAAAAAAAAAFZW5kZWQAAAAAAAABAAAAAAAAAAtoaWdoZXN0X2JpZAAAAAALAAAAAAAAAA5oaWdoZXN0X2JpZGRlcgAAAAAAEwAAAAAAAAAEaXRlbQAAABEAAAAAAAAABnNlbGxlcgAAAAAAEw==",
        "AAAAAAAAAAAAAAADYmlkAAAAAAIAAAAAAAAABmJpZGRlcgAAAAAAEwAAAAAAAAAGYW1vdW50AAAAAAALAAAAAA==",
        "AAAAAAAAAAAAAAALZW5kX2F1Y3Rpb24AAAAAAQAAAAAAAAAGc2VsbGVyAAAAAAATAAAAAA==",
        "AAAAAAAAAAAAAAALZ2V0X2F1Y3Rpb24AAAAAAAAAAAEAAAfQAAAAB0F1Y3Rpb24A",
        "AAAAAAAAAAAAAAAOY3JlYXRlX2F1Y3Rpb24AAAAAAAIAAAAAAAAABnNlbGxlcgAAAAAAEwAAAAAAAAAEaXRlbQAAABEAAAAA" ]),
      options
    )
  }
