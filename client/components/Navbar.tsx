    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#f97316] to-[#fbbf24] shadow-[0_0_20px_rgba(249,115,22,0.3)]">
        ...
        <div className="flex items-center gap-3">
          ...
          {walletAddress ? (
            <div className="relative">
              ...
              >
                <div className="h-6 w-6 rounded-full bg-gradient-to-br from-[#f97316] to-[#fbbf24] p-[1.5px]">
            ...
            <button
              ...
              className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[#f97316] to-[#fb923c] p-[1px] transition-all hover:shadow-[0_0_25px_rgba(249,115,22,0.25)] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
            >
