...
export const CONTRACT_ADDRESS =
  "CCCOKUMZI56EVHL2SHH776YEB72ZK5PDDA73HSCQZM6KKFMLKZGBKS7Q";
...
// ============================================================
// Auction Platform — Contract Methods
// ============================================================

/**
 * Create a new auction.
 * Calls: create_auction(seller: Address, item: Symbol)
 */
export async function createAuction(
  ...
  return callContract(
    "create_auction",
    [toScValAddress(caller), toScValSymbol(item)],
    caller,
    true
  );
}
 ...
 * Calls: bid(bidder: Address, amount: i128)
 */
...
/**
 * End the auction (seller only).
 * Calls: end_auction(seller: Address)
 */
...
/**
 * Get auction details (read-only).
 * Calls: get_auction() -> Auction
 * Returns: { seller, item, highest_bid, highest_bidder, ended }
 */
export async function getAuction(caller?: string) {
  return readContract(
    "get_auction",
    [],
    caller
